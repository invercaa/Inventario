...
DataTable.ext.buttons.copyHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.copy', 'Copiar Registros' );
	},
...
DataTable.ext.buttons.excelHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.excel', 'Descargar Excel' );
	},
...
DataTable.ext.buttons.pdfHtml5 = {
	className: 'buttons-pdf buttons-html5 btn2',
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.pdf', '<i class="fa-solid fa-file-pdf"></i>' );
	},
